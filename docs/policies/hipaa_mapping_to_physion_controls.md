# HIPAA Mappings to Physion Controls

Below is a list of HIPAA Safeguards and Requirements and the Physion controls in place to meet those.

| **Administrative Controls** HIPAA Rule | Physion Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | Physion Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | Physion Control
---------------- | ----------------
