...
| **Administrative Controls** HIPAA Rule | Ovation Control | Inherited
--- | --- | ---
...
| **Physical Safeguards** HIPAA Rule | Ovation Control | Inherited
--- | --- | ---
...
| **Technical Safeguards** HIPAA Rule | Ovation Control | Inherited
--- | --- | ---
...
| **Organizational Requirements** HIPAA Rule | Ovation Control | Inherited
--- | --- | ---
...
| **Policies and Procedures and Documentation Requirements** HIPAA Rule | Ovation Control | Inherited
--- | --- | ---
...
| **HITECH Act - Security Provisions** HIPAA Rule | Ovation Control | Inherited
--- | --- | ---
